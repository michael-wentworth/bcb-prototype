...
export const ANALYST_STUDIES = [
  ...
  },
  {
    ...
    area: 'security',
    format: 'study',
    covers: 'The consolidated security estate, taken as a whole rather than product by product.',
  },
  {
    ...
    area: 'security',
    format: 'infographic',
    covers: 'The headline figures from the Microsoft Security study, on one page.',
  },
  {
    id: 'tei-entra',
    ...
    area: 'security',
    format: 'study',
    covers: 'Identity and access management, including conditional access and lifecycle.',
  },
  {
    id: 'tei-entra-info',
    product: 'Microsoft Entra',
    area: 'security',
    format: 'infographic',
    covers: 'The identity figures on one page, for a customer conversation.',
  },
  {
    id: 'tei-defender-xdr',
  ...
  },
  {
    ...
    area: 'security',
    format: 'study',
    covers: 'Zero Trust as a programme rather than as a set of individual controls.',
  },
  {
  ...
  },
  {
    ...
    area: 'security',
    format: 'study',
    covers: 'Cloud workload protection and posture management across the estate.',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    area: 'security',
    format: 'study',
    covers: 'Cloud-native SIEM: ingestion, analytics and the operations around them.',
  },
  {
    id: 'tei-siem-xdr',
    ...
    area: 'security',
    format: 'study',
    covers: 'SIEM and XDR measured together rather than each on its own.',
  },
  {
    id: 'tei-m365-e3',
  ...
  },
  {
    ...
    area: 'm365',
    format: 'value-share',
    covers: 'The E3 value narrative, built for presenting rather than reading.',
  },
  {
  ...
  },
  {
    ...
    area: 'endpoint',
    format: 'study',
    covers: 'Endpoint management, and what the Intune Suite add-ons contribute on top.',
  },
];
...
export const LEARNING_RESOURCES = [
  {
    ...
    start: true,
    published: 'May 2025',
    blurb: 'The whole tool, step by step — what each field does and how it reaches the report.',
  },
  {
    id: 'intro-video',
    title: 'Intro video',
    format: 'video',
    start: true,
    blurb: 'Build a business case end to end, narrated. The fastest way in if you have not used it.',
  },
  {
    id: 'training-case-study',
    title: 'Training case study',
    format: 'case-study',
    blurb: 'A customer scenario to build alongside, with the inputs and the reasoning behind them.',
  },
  ...
  { id: 'training-identity', title: 'Identity', format: 'training', blurb: 'Identity and access cases, and what displacing a standalone IAM vendor is worth.' },
  { id: 'training-mcd', title: 'MCD', format: 'training', blurb: 'Cloud defence cases: workload protection and posture.' },
  { id: 'training-purview', title: 'Purview', format: 'training', blurb: 'Data security and compliance cases, where the benefit is rarely a displaced contract.' },
  { id: 'training-copilot', title: 'Security Copilot', format: 'training', blurb: 'Making the AI productivity argument without overstating it.' },
];
